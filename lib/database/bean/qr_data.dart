...
enum QrType {
  ...
  ///联系人
  contactInfo(
      name: '联系人', iconData: Icons.contact_phone, color: Color(0xff6ac1ae)),
  ...
  ///日历
  calendarEvent(
      name: '日历', iconData: Icons.calendar_month, color: Color(0xffb56cd1)),

  ///驾照
  driverLicense(
      name: "驾照", iconData: Icons.drive_eta_rounded, color: Color(0xffd9e2c9)),
  ...
  ///枚举名字
  get enumName => toString().split('.').last;
